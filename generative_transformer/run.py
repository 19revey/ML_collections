# import genet
# import torch
from src.genet.util.text_character_tokenizer import TextCharacterTokenizer, TextCharacterDataset
from src.genet.util.config import TrainConfigure, ModelConfigure
from src.genet import Trainer
